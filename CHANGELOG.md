...
## [0.0.0-rfc081-test] - 2026-09-06

Throwaway entry for RFC 081 § 3's live demonstration that
`assert-draft-release` actually fails when it should. Never published;
tag and draft deleted after both failure modes are captured. This
section, this commit, and the version bump that comes with it are not
part of the merged history.
