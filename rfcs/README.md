...
1. Pick the next free number — **049+**. Numbers 039–043 are reserved
   by [ROADMAP.md](../ROADMAP.md) for the planned M3 RFCs; 045 and 048
   are still open. Create `rfcs/proposed/NNN-slug.md`.
