...
| 064 | [Finish the CLI front door](./accepted/064-cli-front-door-completion.md) | merged to `main` (`9f9a193`); **Amendment 1** (`--flag=value`) approved, handed off; **blocking 6.0.0** |
