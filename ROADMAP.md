...
| RFC | Title | Pri | Depends on | State |
|---|---|---|---|---|
| 039 | [An additive-only gate for the public API](./rfcs/proposed/039-public-api-additive-only-gate.md) | P1 | 031 | **Drafted 2026-08-19.** Designed now, **enabled after 6.0.0** — a gate over a moving surface trains people to ignore it |
