...
| 041 | [Error type shape: boxing, `kind()`, `#[non_exhaustive]`](./rfcs/accepted/041-error-type-shape.md) | P2 | — | **Drafted 2026-08-19.** Breaking, so 6.0.0. 15 lint suppressions across 8 files; cause is `toml::de::Error` (88 bytes) held by value in two parse variants |
